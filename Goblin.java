...
public class Goblin extends Enemies {
    ...
    Goblin(String name, int healt, int attackpower) {
    ...
    public int specialAttack(Characters character) {
        System.out.println("The " + this.name + " Attacked your " + character.charactername + " " + character.name
                + " with his special attack Sneaky Stab");
        System.out.println("Your " + character.charactername + " " + character.name + " taked 13 damage");
